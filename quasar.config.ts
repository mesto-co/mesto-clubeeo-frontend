...
function corePath(dir: string) {
  return path.resolve(__dirname, `./node_modules/clubeeo-front/src/${dir}`);
}
...
export default configure((ctx) => {
  return {
    ...
    boot: ['i18n', 'axios', 'pinia', 'components'],
    ...
    build: {
      ...
      alias: {
        ...
        '@layouts': corePath('layouts'),
        '@pages': corePath('pages'),
        '@stores': corePath('stores'),
        '@modules': corePath('modules'),
      },
    },
