...
export const personalSignWalletConnectAdapterFactory = (connector: WalletConnect): TPersonalSignPort => {
  return async (params: TPersonalSignPortParams) => {
    ...
    Notify.create({type: 'info', message: 'Please sign the message using your wallet'})
