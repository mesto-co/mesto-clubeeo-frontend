  ...
  >
    ...
    >
      ...
      <q-card
        ...
        class='q-mb-lg'
        :dark='theme.dark'
        :style='{backgroundColor: theme.card.color, border: 0, borderRadius: "12px"}'
      >
  ...
  setup() {
    ...
    const onLoad = async () => {
      ...
      if (state.$club.clubSlugRouteParam.value) {
        ...
        await state.$clubApp.loadClubApp({clubAppSlug: $route.params.appSlug.toString()});
