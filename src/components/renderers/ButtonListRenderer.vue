<template>
  <template v-for="(taskStep, i) in data.steps" v-bind:key="i">
    <div v-if="!taskStep.type">
      <div class="row">
        ...
        <div v-if="taskStep.points" class="col-auto q-pl-xs text-right">
          <q-icon
        ...
        <div v-else class="col-auto q-pl-sm text-right">
