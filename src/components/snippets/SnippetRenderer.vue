<template>
  <divs v-if="Array.isArray(data)" :data="{ items: data }" />
  ...
  >
    <template v-slot>
      <snippet-renderer :data="snippet.slot" />
    </template>
  </component>
  ...
  >
    <template
      ...
      v-slot:[slotName]
    >
      <snippet-renderer :data="slotData" />
    </template>

    <template v-if="!snippet.slots" v-slot>
      <snippet-renderer :data="snippet.slot" />
    </template>
  </component>
</template>
