<template>
  ...
  <div v-if="!isClubLoading" class="aside" style="padding: 30px 0">
    <div
    ...
    <template v-if="!isLoggedIn">
      <div class="row">
        ...
        <div class="col-auto q-pl-sm">
          <q-icon :name="undefined" size="sm" color="grey-6" />
        </div>
      </div>
    </template>
    <template v-else>
      <div class="row">
        ...
        <div class="col-auto q-pl-sm">
          <q-icon name="fa fa-check" size="sm" color="grey-6" />
        </div>
      </div>
    </template>
    ...
    <onborading-tasks-widget v-else />
  </div>
