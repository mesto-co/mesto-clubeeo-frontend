...
export const demoLendingPageDataShort: ISnippetData = buildDemoLandingPage({
  ...
  taskSup:
    "<p class='text-center'>complete tasks to join our waitlist and get notified once we launched</p>",
  taskSub: demoSub,
});
...
export const demoLendingPageDataReferral: ISnippetData = buildDemoLandingPage({
  ...
  taskSup:
    "<p class='text-center'>join our waitlist and invite friends to win our premium and ultra-rare NFTs</p>",
  taskSub: demoSub,
  footerAside: {
    type: 'demo:leaderboardStatus',
    data: { position: 10, name: 'Obi-Wan', points: 5 },
    class: 'q-mb-md',
  },
});
...
export const demoLendingPageData: ISnippetData = buildDemoLandingPage({
  ...
  taskSup:
    "<p class='text-center'>complete tasks to receive our NFT<br />and get role in Discord</p>",
  taskSub: demoSub,
});
...
function buildDemoLandingPage(opts: {
  ...
  return {
    ...
    middle: opts.middleBlock || {
      ...
      descriptionHtml:
        '<p>we are P2E game, metaverse experience and investment DAO at the same time!</p>\n' +
    ...
    footer: opts.footerBlock || {
      ...
      smallTextHtml:
        "this is <a href='https://clubeeo.com' target='_blank'>clubeeo.com</a> demo",
    },
    aside: {
      middle: {
        type: 'divs',
