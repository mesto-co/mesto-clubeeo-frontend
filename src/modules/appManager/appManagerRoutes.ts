...
export const appManagerRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: () =>
      import('@src/modules/appManager/pages/ClubAppsRegistryPage.vue'),
  ...
  },
  {
    ...
    component: () =>
      import('@src/modules/appManager/pages/ClubAppInstallPage.vue'),
    meta: { parent: { name: 'club-apps' } },
  },
  {
    ...
    component: () =>
      import('@src/modules/appManager/pages/ClubAppEditPage.vue'),
    meta: { parent: { name: 'club-apps' } },
  },
  {
    ...
    name: 'club-app-logs',
    component: () =>
      import('@src/modules/appManager/pages/ClubAppLogsPage.vue'),
    meta: { parent: { name: 'club-apps' } },
  },
];
