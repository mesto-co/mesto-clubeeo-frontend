<template>
  ...
  <div class='row'>
    ...
    <div class='col-auto q-pl-lg'>
      <q-toggle
        color="primary" checked-icon="check" unchecked-icon="clear"
  ...
  <c-select
    ...
    class='q-mb-md'
    v-model='triggerStore.processingType' map-options emit-value
...
export default defineComponent({
  ...
  setup() {
    ...
    const processingTypeOption = computed(() => triggerStore?.processingType ? processingTypeOptionsMap[triggerStore.processingType] : null);
