        ...
        <div class="flex" style="width: 299px">
          ...
          >
            <q-list style="width: 52px">
              ...
              <template v-for="club in clubList" :key="club.slug">
                <q-item
                  clickable
                  :to="{ name: club.slug }"
                  style="
          ...
          <div style="background-color: rgb(29 29 39); width: 223px">
              ...
              <q-list style="margin: 12px 8px 12px 8px">
                ...
                <template v-for="link in essentialLinks" :key="link.title">
                  ...
                  <q-item
                    ...
                    :class="{
                      clubButtonActive: isCurrentRoute(link.toName),
                      clubMenuItem: true,
                    }"
                  >
            ...
            <div
              ...
              :class="{
                flex: true,
                clubButtonActive: isCurrentRoute('demo-club-me'),
              }"
...
.demoActive {
  ...
  background: linear-gradient(
    30deg,
    rgba(rgb(21, 75, 208), 1) 25%,
    rgba(rgb(111, 23, 212), 1)
  );
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      essentialLinks: computed(() =>
        $route.query.short ? linksList : longLinksList
      ),
      clubList,
      leftDrawerOpen,
      isCurrentRoute,
